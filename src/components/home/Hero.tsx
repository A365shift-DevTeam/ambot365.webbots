    ...
    <section className="relative overflow-hidden bg-white" id="hero">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36">
        <div className="max-w-3xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-50 border border-brand-200 text-brand-700 text-xs font-medium mb-8 animate-fade-in">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight leading-tight mb-6 animate-slide-up">
            {BRAND.tagline.split('Premium AI')[0]}
            <span className="gradient-text">Premium AI Chatbot Services</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up delay-200">
            <Link
              href="/bots"
              id="view-bots-btn"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-brand-500 to-brand-600 text-white font-semibold shadow-lg hover:shadow-xl hover:from-brand-600 hover:to-brand-700 transition-all duration-300 transform hover:-translate-y-0.5"
            >
              View Bots
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white border border-slate-200 text-slate-700 font-semibold shadow-sm hover:shadow-md hover:border-brand-300 hover:text-brand-700 transition-all duration-300"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gradient-to-br from-slate-50 to-brand-50/30 rounded-xl p-8 sm:p-10">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {[
                  ...
                  >
                    <div className={`w-10 h-10 mx-auto mb-2 rounded-lg bg-gradient-to-br ${item.color} flex items-center justify-center text-lg shadow-sm`}>
                      {item.icon}
                    </div>
